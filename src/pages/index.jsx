  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> I'm Vyas Swaroop.
          </BigTitle>
          <Subtitle>Devops Engineer who designs a secure, scalable and reliable infrastructure.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            ...
            >
              Deploying Kubernetes clusters from scratch and configuring it for production usage.
            </ProjectCard>
            <ProjectCard
              title="Configuring automatic deployment of code"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              Configuring CI and CD for the complete automation for deployment of applications.
            </ProjectCard>
            <ProjectCard
              title="Dockerizing applications"
              bg="linear-gradient(to right, #009245 0%, #FCEE21 100%)"
            >
              Containarizing application with Docker.
            </ProjectCard>
            <ProjectCard
              title="Setting up Distributed Databases"
              bg="linear-gradient(to right, #D585FF 0%, #00FFEE 100%)"
            >
              Building Production database clusters with Replication and Sharding.
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <AboutHero>
            ...
            <AboutSub>
              Software Engineer and Tech Enthusiast with more than 3 years of Industrial experience in DevOps technologies
              in designing a secure, scalable and reliable infrastructure with minimum deployment complexity aiming to handle
              hundreds of deployments a day.
            </AboutSub>
          </AboutHero>
          <AboutDesc>
            Interested to learn and work on diverse fields. Like to work in a challenging and competing environment, and to
            work with people of higher experience in the field. Like to be a part of a larger community and know the various
            challenges faced and to work as a team to solve those. Extremely enthusiastic to learn new and implement those.
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:vyasswaroop@gmail.com">Hi</a> or find me on other platforms:{' '}
            <a href="https://github.com/vyasswaroop/">Github</a> &{' '}
            <a href="https://www.linkedin.com/in/vyasswaroop/">LinkedIn</a>
          </ContactText>
        </Inner> 
      </Content>
